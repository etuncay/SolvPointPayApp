...
export const AGENT_GROUPS: AgentGroup[] = [
  { key: 'platinum', label: 'Platin', commission: 0.3 },
  { key: 'gold', label: 'Altın', commission: 0.45 },
  { key: 'standard', label: 'Standart', commission: 0.55 },
];
...
export const AGENTS: Agent[] = Array.from({ length: 42 }, (_, i) => makeAgent(i)).map((a, i) => ({
  ...a,
  id: 99901 + i,
